    ...
    <div class="container">
      ...
      <div class="sobre-content-wrapper">
        ...
        <div class="sobre-text">
          ...
          <p>
            <b>Desenvolvedor</b> e entusiasta do mundo tech, iniciei minha carreira em 2017 e desde então me apaixonei 
            cada vez mais por códigos, o que me levou a buscar cada vez mais conhecimento em diferentes <b>tecnologias</b>.
          </p>

          <p>
            Iniciei minha carreira como <b>Desenvolvedor FullStack</b>, aprendo com facilidade e estou sempre 
            antenado em tecnologias novas.
            Como um bom escoteiro gosto de aplicar os princípios de <b>clean code</b> por onde passo, para deixar o 
            código melhor do que quando o encontrei.
          </p>

          <p>
            Possuo experiência nas linguagens <b>Javascript</b>, <b>Kotlin</b>, <b>Python</b>, <b>Ruby</b> e <b>NodeJS</b>. 
            Já no frontend utilizo <b>Reactjs</b> e <b>Nextjs</b> com <b>Typescript</b> e <b>Material UI</b>, 
            além de desenvolvimento mobile utilizando <b>React Native</b>.
          </p>


          <p>
            Estou em constante processo de aprendizado, buscando sempre aprender e aperfeiçoar meus conhecimentos, 
            participando de <b>eventos</b>, <b>conferências</b>, <b>workshops</b> e <b>cursos de programação</b> e <b>tecnologia</b>.
          </p>
  ...
  <div class="section" id="skills">
    <div class="container">
      ...
      <div class="skills-content-wrapper">
        ...
        <div class="skill">
          <div class="icon fa-nextjs"></div>
          <h3>NextJS</h3>
          <p>NextJS é framework para React focado em produtividade.</p>
        ...
        <div class="skill">
          <i class="fab icon fa-react fa-2x"></i>
          <h3>React Native</h3>
          <p>React Native é uma biblioteca Javascript usada para desenvolvedor aplicativos nativos.</p>
        ...
        <div class="skill">
          <div class="fab icon fa-docker fa-2x"></div>
          <h3>Docker</h3>
          <p>Docker simplifica o processo de construção, execução, gerenciamento e distribuição dos apps.</p>
        ...
        <div class="skill">
          <div class="icon fa-kotlin"></div>
          <h3>Kotlin</h3>
          <p>É uma linguagem multiplataforma orientada a objetos, funcional e estaticamente tipada.</p>
        ...
        <div class="skill">
          <div class="fab icon fa-java fa-2x"></div>
          <h3>Java</h3>
          <p>Java é uma linguagem de programação orientada a objetos, segura e independente de plataforma.</p>
        ...
        <div class="skill">
          <i class="fab icon fa-jenkins fa-2x"></i>
          <h3>Jenkins</h3>
          <p>Jenkins é um servidor de automação que facilita o processo de integração contínua.</p>
  ...
  <div class="section" id="portfolio">
    <div class="container">
      ...
      <div class="portfolio-content-wrapper">
        <a data-fancybox="gallery" href="images/mcdigital.png" data-caption="Site da empresa <a class='portfolio_link' href='https://mcdigital.com' target='_blank'>Mc Digital.</a>">
          <img src="images/mcdigital2.png" alt="Site Mc Digital">
        </a>
        <a data-fancybox="gallery" href="images/ultrapel.png" data-caption="Site da empresa <a class='portfolio_link' href='https://ultrapel.com.br' target='_blank'>Ultrapel.</a>">
        ...
        <a data-fancybox="gallery" href="images/borgfy.png" data-caption="Site da empresa <a class='portfolio_link' href='https://borgfy.com' target='_blank'>Borgfy</a> feito utilizando NextJS.">
          <img src="images/borgfy2.png" alt="Jogos para Bienal 2019">
        </a>
      </div>
    </div>
  </div>
